$(document).ready(function () {
    ...
    var mcq = '<div class="mcq-parent"><div class="form-row domain-name"><div class="form-group col-md-6"><input type="text"class="form-control"name="mcqQues-name"placeholder="Enter MCQ Question"></div></div><div class="form-row domain-name"><div class="form-group col-md-2"><input type="text"class="form-control"name="mcq-opt-a"placeholder="Option A"></div><div class="form-group col-md-2"><input type="text"class="form-control"name="mcq-opt-b"placeholder="Option B"></div><div class="form-group col-md-2"><input type="text"class="form-control"name="mcq-opt-c"placeholder="Option C"></div><div class="form-group col-md-2"><input type="text"class="form-control"name="mcq-opt-d"placeholder="Option D"></div><div class="form-group col-md-2"><input type="text"class="form-control"name="mcq-ans"placeholder="Answer"></div><div class="form-group col-md-2"><a href="#"class="remove_field">Remove</a></div><input type="hidden"name="question-type"value="MCQ"></div></div>'
    var longAns = '<div class="form-row domain-name"><div class="form-group col-md-6"><input type="text"class="form-control"name="laQues-name"placeholder="Enter Long Answer Question"></div><input type="hidden"name="question-type"value="LA"><div class="form-group col-md-6"><a href="#"class="remove_field">Remove</a></div></div>'
    $(".MCQ").on("click", () => {
